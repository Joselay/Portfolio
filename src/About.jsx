            ...
            <div className='flex flex-col gap-8 lg:flex-row lg:mt-16 lg:gap-0'>
                <div className='flex flex-col gap-8 lg:w-[80%] lg:justify-between lg:h-1/2'>
                    <div className='flex flex-col gap-5 pt-8 lg:justify-between lg:pt-0 lg:gap-4 '>
                        ...
                        <p className='text-sm text-[#e4e4e4] leading-6 lg:w-[90%] '>Feel free to reach out to me for any web development needs or inquiries. Let's collaborate and create something amazing together.</p>
                    </div>
                ...
                <form className='grid grid-cols-2 gap-3 lg:w-full'>
                    ...
                    <input className='placeholder-[#868e96] bg-[#222] text-[#eee] py-3 text-sm px-4 rounded-md outline-none col-span-2 md:col-span-1 lg:col-span-1' type="email" placeholder='Email' />
                    <input className='bg-[#222] text-[#eee] py-3 placeholder-[#868e96] text-sm px-4 rounded-md outline-none col-span-2 md:col-span-1 lg:col-span-1' type="text" placeholder='Website' />
                    <textarea placeholder='Message' className=' bg-[#222] col-span-2 placeholder-[#868e96] text-[#eee] py-2 px-4 rounded-md outline-none text-sm lg:h-40' name="messageContent" cols="30" rows="10" />
